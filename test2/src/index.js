   ...
   let knightMoves = [
    ...
    function tryMove(moves,coordinates) {
        ...
        for(let i = 0;i < moves.length; i++) {
            ...
            /* т.к. координату, переданную в массив мы изменили, то делаем новую. правильнее было бы вызвать эту ыункцию столько раз,
             сколько вариантов движения в массиве, в 4 задании переделаю*/
